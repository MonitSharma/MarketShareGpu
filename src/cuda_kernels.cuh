...
public:
    ...
    GpuData() = default;
    GpuData(const MarkShareFeas &ms_inst, const std::vector<std::vector<size_t>>& set1_subsets, const std::vector<std::vector<size_t>>& set2_subsets, const std::vector<std::vector<size_t>>& set3_subsets, const std::vector<std::vector<size_t>>& set4_subsets, const std::vector<size_t>& asc_indices_set2_weights, const std::vector<size_t>& desc_indices_set4_weights);
    ...
    size_t* asc_indices_set2_weights;
    ...
    size_t* desc_indices_set4_weights;
