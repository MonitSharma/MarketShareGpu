...
public:
    ...
    GpuData() = default;
    GpuData(const MarkShareFeas &ms_inst, const std::vector<std::vector<size_t>>& set1_subsets, const std::vector<size_t>& set1_scores, const std::vector<std::vector<size_t>>& set2_subsets, const std::vector<size_t>& set2_scores, const std::vector<std::vector<size_t>>& set3_subsets, const std::vector<size_t>& set3_scores, const std::vector<std::vector<size_t>>& set4_subsets, const std::vector<size_t>& set4_scores);
